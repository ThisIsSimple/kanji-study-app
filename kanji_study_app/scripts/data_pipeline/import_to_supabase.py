...
def load_client():
    ...
    key = os.getenv("SUPABASE_SECRET_KEY") or os.getenv("SUPABASE_SERVICE_ROLE_KEY") or os.getenv("SUPABASE_ANON_KEY")
    if not url or not key:
        raise RuntimeError(
            "SUPABASE_URL and SUPABASE_SECRET_KEY, SUPABASE_SERVICE_ROLE_KEY, or SUPABASE_ANON_KEY are required"
        )
...
def prepare_word(row: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "meanings_jp": row.get("meanings_jp") or [],
...
def prepare_kanji(row: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "meanings_ko": row.get("meanings_ko") or row.get("meanings") or [],
        "meanings_en": row.get("meanings_en") or [],
        "kr_meanings": row.get("kr_meanings") or row.get("meanings_ko") or row.get("meanings") or [],
        "jp_meanings": row.get("jp_meanings") or [],
        "en_meanings": row.get("en_meanings") or row.get("meanings_en") or [],
        "on_readings": readings.get("on") or [],
        "kun_readings": readings.get("kun") or [],
        "jp_on_readings": row.get("jp_on_readings") or readings.get("on") or [],
        "jp_kun_readings": row.get("jp_kun_readings") or readings.get("kun") or [],
        ...
        "jp_commentary": row.get("jp_commentary"),
        "en_commentary": row.get("en_commentary"),
