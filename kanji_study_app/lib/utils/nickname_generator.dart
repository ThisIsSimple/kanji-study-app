...
class NicknameGenerator {
  ...
  String generate(String userId) {
    ...
    final adjIndex =
        int.parse(hash.substring(0, 8), radix: 16) % _adjectives.length;
    final nounIndex =
        int.parse(hash.substring(8, 16), radix: 16) % _nouns.length;
    final number = (int.parse(hash.substring(16, 24), radix: 16) % 10000)
        .toString()
        .padLeft(4, '0');
